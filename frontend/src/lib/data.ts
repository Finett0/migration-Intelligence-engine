...
const costs: Record<Platform, Record<RevenueRange, CostBreakdown>> = {
  shopify: {
    "10k":      { planLabel: "US$ 29 (~R$ 180)", planValue: 180, txRate: 0.02, txLabel: "2%", appsValue: 150, appsLabel: "R$ 150", nuvemPlan: 349 },
    "10k-50k":  { planLabel: "US$ 79 (~R$ 490)", planValue: 490, txRate: 0.02, txLabel: "2%", appsValue: 300, appsLabel: "R$ 300", nuvemPlan: 599 },
    "50k-100k": { planLabel: "US$ 299 (~R$ 1.850)", planValue: 1850, txRate: 0.015, txLabel: "1,5%", appsValue: 500, appsLabel: "R$ 500", nuvemPlan: 599 },
    "100k-500k":{ planLabel: "US$ 299 (~R$ 1.850)", planValue: 1850, txRate: 0.015, txLabel: "1,5%", appsValue: 800, appsLabel: "R$ 800", nuvemPlan: 999 },
    "500k+":    { planLabel: "US$ 2.300 (~R$ 14.260)", planValue: 14260, txRate: 0.005, txLabel: "0,5%", appsValue: 1200, appsLabel: "R$ 1.200", nuvemPlan: 1999 },
  },
  tray: {
    "10k":      { planLabel: "R$ 299", planValue: 299, txRate: 0, txLabel: "0%", appsValue: 100, appsLabel: "R$ 100", nuvemPlan: 349 },
    "10k-50k":  { planLabel: "R$ 599", planValue: 599, txRate: 0, txLabel: "0%", appsValue: 200, appsLabel: "R$ 200", nuvemPlan: 599 },
    "50k-100k": { planLabel: "R$ 999", planValue: 999, txRate: 0, txLabel: "0%", appsValue: 300, appsLabel: "R$ 300", nuvemPlan: 599 },
    "100k-500k":{ planLabel: "R$ 1.499", planValue: 1499, txRate: 0, txLabel: "0%", appsValue: 400, appsLabel: "R$ 400", nuvemPlan: 999 },
    "500k+":    { planLabel: "R$ 2.499", planValue: 2499, txRate: 0, txLabel: "0%", appsValue: 600, appsLabel: "R$ 600", nuvemPlan: 1999 },
  },
  woocommerce: {
    "10k":      { planLabel: "Hosting (~R$ 150)", planValue: 150, txRate: 0, txLabel: "0%", appsValue: 200, appsLabel: "R$ 200 (plugins)", nuvemPlan: 349 },
    "10k-50k":  { planLabel: "Hosting (~R$ 300)", planValue: 300, txRate: 0, txLabel: "0%", appsValue: 400, appsLabel: "R$ 400 (plugins)", nuvemPlan: 599 },
    "50k-100k": { planLabel: "Hosting (~R$ 600)", planValue: 600, txRate: 0, txLabel: "0%", appsValue: 600, appsLabel: "R$ 600 (plugins + dev)", nuvemPlan: 599 },
    "100k-500k":{ planLabel: "Hosting (~R$ 1.200)", planValue: 1200, txRate: 0, txLabel: "0%", appsValue: 1500, appsLabel: "R$ 1.500 (dev + plugins)", nuvemPlan: 999 },
    "500k+":    { planLabel: "Hosting (~R$ 2.500)", planValue: 2500, txRate: 0, txLabel: "0%", appsValue: 3000, appsLabel: "R$ 3.000 (dev + infra)", nuvemPlan: 1999 },
  },
  "loja-integrada": {
    "10k":      { planLabel: "R$ 99", planValue: 99, txRate: 0, txLabel: "0%", appsValue: 50, appsLabel: "R$ 50", nuvemPlan: 349 },
    "10k-50k":  { planLabel: "R$ 299", planValue: 299, txRate: 0, txLabel: "0%", appsValue: 100, appsLabel: "R$ 100", nuvemPlan: 599 },
    "50k-100k": { planLabel: "R$ 599", planValue: 599, txRate: 0, txLabel: "0%", appsValue: 150, appsLabel: "R$ 150", nuvemPlan: 599 },
    "100k-500k":{ planLabel: "R$ 999", planValue: 999, txRate: 0, txLabel: "0%", appsValue: 200, appsLabel: "R$ 200", nuvemPlan: 999 },
    "500k+":    { planLabel: "R$ 1.499", planValue: 1499, txRate: 0, txLabel: "0%", appsValue: 300, appsLabel: "R$ 300", nuvemPlan: 1999 },
  },
  outra: {
    "10k":      { planLabel: "~R$ 200", planValue: 200, txRate: 0.01, txLabel: "~1%", appsValue: 100, appsLabel: "~R$ 100", nuvemPlan: 349 },
    "10k-50k":  { planLabel: "~R$ 500", planValue: 500, txRate: 0.01, txLabel: "~1%", appsValue: 250, appsLabel: "~R$ 250", nuvemPlan: 599 },
    "50k-100k": { planLabel: "~R$ 800", planValue: 800, txRate: 0.01, txLabel: "~1%", appsValue: 400, appsLabel: "~R$ 400", nuvemPlan: 599 },
    "100k-500k":{ planLabel: "~R$ 1.500", planValue: 1500, txRate: 0.01, txLabel: "~1%", appsValue: 600, appsLabel: "~R$ 600", nuvemPlan: 999 },
    "500k+":    { planLabel: "~R$ 3.000", planValue: 3000, txRate: 0.01, txLabel: "~1%", appsValue: 1000, appsLabel: "~R$ 1.000", nuvemPlan: 1999 },
  },
};
